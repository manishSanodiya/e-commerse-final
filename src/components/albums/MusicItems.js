    ...
    if (cartItemIndex < 0) {
      try {
        const res = await fetch(
          `https://crudcrud.com/api/a605560aaf5b4cf789ec2e7e7a372715/${userEmail}`,
          {
            method: 'POST',
            body: JSON.stringify({
              title: product.title,
      ...
      try {
        await fetch(
          ` https://crudcrud.com/api/a605560aaf5b4cf789ec2e7e7a372715/${userEmail}/${updatedItem[cartItemIndex]._id}`,
          {
            method: 'PUT',
            body: JSON.stringify({
              title: product.title,
